...
async def post_init(
    ...
    # Telegram's blue three-dash Menu button is the Mini App launcher.
    # The player reply keyboard remains the keyboard that Telegram can show/hide
    # with its keyboard icon beside the message input field.
    try:
        await application.bot.set_my_commands([
            BotCommand("start", "Start / register"),
            BotCommand("play", "Open Bingo Mini App"),
        ...
        logger.info("Telegram Menu button configured as Play Games.")
    except Exception as e:
        logger.warning("Could not configure Telegram menu button: %s", e)
