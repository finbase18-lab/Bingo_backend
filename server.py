...
def progress_round(round_id):
    ...
    with engine_lock:
        ...
        if status == "PLAYING":
            ...
            # The client keeps the WINNER screen visible for three seconds.
            # On the next poll/open request, close the old round completely so
            # the room can immediately create a fresh cartel-selection round.
